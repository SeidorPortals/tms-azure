...
export class CarrierscostService {
  ...
  CreateObj(equipmentObj: any): Observable<ResponseHelper> {
    ...
    //console.log(data);
    return this.http.post(this.baseUrl + 'carriercost', data, requestOptions)
    .pipe(  
      //manejo de errores
  ...
  EditObj(Obj: any): Observable<ResponseHelper> {
    ...
    //console.log(data);
    return this.http.patch(this.baseUrl + 'carriercost', data, requestOptions)
    .pipe(  
      //manejo de errores
      timeout(this.vs.waitTime), //tiempo de espera
      catchError((error: HttpErrorResponse | TimeoutError) => {
  ...
  deleteBy(params: any): Observable<ResponseHelper> {
    ...
    return this.http.delete(this.baseUrl + 'carriercost', options)
    .pipe(  
      //manejo de errores
      timeout(this.vs.waitTime), //tiempo de espera
      catchError((error: HttpErrorResponse | TimeoutError) => {
 ...
 getByPromise(params: any): Promise<any>{
    ...
    return new Promise( (resolve, reject) => {
      this.http.get<any>(this.baseUrl + 'carriercost', options)
      .pipe(  
        //manejo de errores
        timeout(this.vs.waitTime), //tiempo de espera
        catchError((error: HttpErrorResponse | TimeoutError) => {
  ...
  getAll(): Observable<any> {
    ...
    return this.http.get<any>(this.baseUrl + 'carriercost',options)
    .pipe(  
      //manejo de errores
      timeout(this.vs.waitTime), //tiempo de espera
      catchError((error: HttpErrorResponse | TimeoutError) => {
  ...
  getBy(params: any): any{
    ...
    return this.http.get(this.baseUrl + 'carriercost', options)
    .pipe(  
      //manejo de errores
      timeout(this.vs.waitTime), //tiempo de espera
      catchError((error: HttpErrorResponse | TimeoutError) => {
